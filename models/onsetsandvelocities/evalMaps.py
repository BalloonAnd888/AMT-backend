...
from preprocessing.constants import N_KEYS, MAPS_DATA_PATH, SAMPLE_RATE, SEQUENCE_LENGTH, WINDOW_LENGTH, HOP_LENGTH, N_MELS, MEL_FMAX, MEL_FMIN
from preprocessing.mel import MelSpectrogram
from models.onsetsandvelocities.evaluate import threshold_eval_single_file
from preprocessing.dataset import MAPS
...
def evaluate(model_path, data_path=MAPS_DATA_PATH, save_path=None):
    print(f"Evaluating model on {DEVICE}...")

    # Initialize with empty groups to avoid pre-loading into memory
    dataset = MAPS(path=data_path, groups=['test'], sequence_length=SEQUENCE_LENGTH)
