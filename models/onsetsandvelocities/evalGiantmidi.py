...
from preprocessing.constants import N_KEYS, GIANTMIDI_DATA_PATH, SAMPLE_RATE, SEQUENCE_LENGTH, WINDOW_LENGTH, HOP_LENGTH, N_MELS, MEL_FMAX, MEL_FMIN
from preprocessing.mel import MelSpectrogram
from models.onsetsandvelocities.evaluate import threshold_eval_single_file
from preprocessing.dataset import GIANTMIDI
...
def evaluate(model_path, data_path=GIANTMIDI_DATA_PATH, save_path=None):
    print(f"Evaluating model on {DEVICE}...")

    # Initialize with empty groups to avoid pre-loading into memory
    dataset = GIANTMIDI(path=data_path, groups=['test'], sequence_length=SEQUENCE_LENGTH)
    test_files = dataset.files('test')
...
if __name__ == "__main__":
    ...
    print("--- OnsetsAndVelocities Evaluation on GIANTMIDI ---")
